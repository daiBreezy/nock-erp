...
const _students = [
  { id:'mia', name:'Mia Tanaka', age:9, branch:'Sukhumvit', family:'Tanaka Family',
    ...
    invoices:[{id:'INV-2026-0032',date:'2026-02-01',amount:14400,status:'paid',course:'Eng Active 48h.'}],
    notes:[
  ...
  { id:'tom', name:'Tom Chen', age:12, branch:'Sukhumvit', family:'Chen Family',
    ...
    invoices:[{id:'INV-2026-0028',date:'2026-01-15',amount:10800,status:'paid',course:'Math G6 36h.'}],
    notes:[
  ...
  { id:'james', name:'James Wilson', age:11, branch:'Sukhumvit', family:'Wilson Family',
    ...
    invoices:[{id:'INV-2026-0041',date:'2026-03-01',amount:4800,status:'paid',course:'Science 12h.'}],
    notes:[
  ...
  { id:'kevin', name:'Kevin Park', age:8, branch:'Silom', family:'Park Family',
    ...
    invoices:[{id:'INV-2026-0048',date:'2026-04-01',amount:7200,status:'paid',course:'Eng Read 24h.'}],
    notes:[
...
const _staff = [
  { id:'arm', name:'Kru Arm', fullName:'Aranya Sombat',   role:'Teacher', subject:'Math G5',
    ...
    students:['Ploy Srirak'],
    schedule:[{day:'Mon',sessions:['Math G5 · 09:00 Rm1','Math G5 · 15:00 Rm2']},{day:'Wed',sessions:['Math G5 · 15:00 Rm2']},{day:'Thu',sessions:['Math G6 · 15:00 Rm2 (co-teach)']}],
  ...
  { id:'bee', name:'Kru Bee', fullName:'Benyapa Rattana',  role:'Teacher', subject:'English Reading',
    ...
    schedule:[{day:'Mon',sessions:['Eng Read · 09:00 Rm1']},{day:'Tue',sessions:['Eng Read · 10:30 Rm1']},{day:'Wed',sessions:['Eng Read · 10:30 Rm1']},{day:'Thu',sessions:['Eng Read · 10:30 Rm1']},{day:'Sat',sessions:['Eng Read · 09:00 Rm1','Math G6 · 10:00 Rm2']}],
  ...
  { id:'cat', name:'Kru Cat', fullName:'Chotika Panya',    role:'Teacher', subject:'Math Grade 6',
    ...
    students:['Tom Chen'],
    schedule:[{day:'Tue',sessions:['Math G6 · 15:00 Rm2']},{day:'Wed',sessions:['Math G6 · 15:00 Rm2']},{day:'Thu',sessions:['Math G6 · 15:00 Rm2']},{day:'Sat',sessions:['Math G6 · 10:00 Rm2']}],
    notes:[]},
  ...
  { id:'eve', name:'Kru Eve', fullName:'Evapha Chinarat',  role:'Teacher', subject:'Thai Language',
    ...
    students:['Ploy Srirak'],
    schedule:[{day:'Mon',sessions:['Thai Lang · 16:30 Rm1']},{day:'Wed',sessions:['Thai Lang · 16:30 Rm1']},{day:'Sat',sessions:['Thai Lang · 15:00 Rm1']}],
    notes:[]},
...
const _leads = [
  ...
  {id:'kevin', name:'Kevin Park (Lead)',course:'Thai Language',  age:8,  source:'Referral',   stage:'contacting', daysAgo:4,  assignee:'Kru Eve',    line:'@park_mom',  phone:'089-777-8888'},
...
const _const = {
  ...
  SUBJECT_COLOR: {'Math G5':'green','Math G6':'','Eng Read':'yellow','Eng Active':'yellow','Science':'orange','Thai Lang':'green'},
  TIME_SLOTS: [
  ...
  SUBJECTS:    ['Math G5','Math G6','Eng Read','Science','Thai Lang'],
  GRADES:      ['G3','G4','G5','G6'],
